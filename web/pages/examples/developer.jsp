...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <li><a href="" data-toggle="modal" data-target="#partnerrequest" style="color:white;"><span class="ion-person-stalker"></span> Request a Partner</a></li>
            ...
            <li><a href="project.jsp" style="color:white;"><span class="ion-ios-paper"></span> Projects</a></li>
            <li><a href="ressource.jsp" style="color:white;"> <span class="ion-ios-folder"></span> Resources</a></li>
             ...
             <li><a href="Conversion.jsp" style="color:white;"><span class="ion-ios-paper"></span> Discussion</a></li>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="conference">
                   <%
                    ResultSet RS=ccc.getcon().prepareStatement("select EventName,InstitutionName,Description,dttime, EventID FROM Event ORDER BY EventID DESC limit 50  ").executeQuery();
               while(RS.next())
               {
                %>
                <div class="post">
                  ...
                  <div class="col-md-12">
                    <div class="table-responsive">
                     ...
                     //String popo="%%1111100abw@zuzu@!-=gwy11101101$$";
                             rs=ccc.getcon().prepareStatement("select User.UserID,User.UserName,Program.ProgramID,Program.ProgramName from User,Program where Program.ProgramID=User.ProgramID and User.UserCategoryID= 2 ").executeQuery();
                             while (rs.next())
                         {  
                          ...
                          <tr>
                            ...
                            <td><%=rs.getString(4) %></td>
                               <%
                               ResultSet Rs=ccc.getcon().prepareStatement("select Status  from MentorRequest where MentorID="+rs.getInt(1)+" and UserID= 346 ").executeQuery();
                           if (!Rs.next())    
                           { 
                               %>

                            <td><a class="btn btn-info btn-sm" href="developer.jsp?sur=tseuqer&M=<%=rs.getInt(1)*1239870%>&U=<%=346*1239870%>" >Request</a></td>
